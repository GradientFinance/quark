        ...
        <div className="dropdown">
          <div tabindex="0" className="bg-opacity-100">
            <div className="tabs w-full flex-grow-0">
              ...
              <button className="tab tab-lifted tab-border-none tab-lg flex-1" onClick={setShortActive}>Long</button>
            </div>
          </div>
        </div>
        <div className="bg-base-100 grid w-full flex-grow gap-3 rounded-xl rounded-tr-none p-6 shadow-xl">
          <div className="relative rounded-md border border-gray-300 px-3 py-3 shadow-sm focus-within:border-indigo-600 focus-within:ring-1 focus-within:ring-indigo-600">
            ...
            <input
              ...
              name="price"
              id="price"
              className="block w-full border-0 p-0 text-gray-900 placeholder-gray-500 focus:ring-0 sm:text-sm pl-4 pr-12 focus:border-indigo-500 focus:ring-indigo-500"
              placeholder="0.00"
          ...
          <div className="divider text-base-content/60 m-0">Returns</div>
          <dl className="mb-2 mt-1 space-y-4">
            ...
            <div className="flex items-center justify-between border-t border-gray-200 pt-4">
              ...
              <dd className="text-base font-medium text-gray-900">$112.32
                <br></br>
                <button className="badge badge-ghost badge-sm">10% LTV</button>
              </dd>
            </div>
          </dl>
